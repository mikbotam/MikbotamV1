Karena tutorialnya blm ada kita maual dulu


Pastikan server sudah terinstall webserver (apache, PHP, MYSQL);

buat lah database terserah namanya
setelah itu  pilih import database, import file publis.sql di folder ini ke databasenya
...
tutorial lain akan saya update
