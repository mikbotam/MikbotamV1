...
//=====================================================START SCRIPT====================//
    ...
    if ($page == null) {
        ...
        $hideBodyHotspot = 'class="collapsed-menu show-mailbox-left"';
        $hSHOWHotspot    = "show-sub";
        $Hotspot         = "active";
    } elseif ($page == "PPP") {
        $hideBodyPPP = 'class="collapsed-menu show-mailbox-left"';
        $hSHOWPPP    = "show-sub";
        $Hotspot     = "active";
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="?Mikbotam=comingsoon" class="sl-menu-link "  >
         ...
         <a href="#" class="sl-menu-link <?=$Maddprofile;?>">
          <div class="sl-menu-item">
            ...
            <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a class="nav-link <?=$addprofilec;?>" href="?Mikbotam=addprofile"><i class="fa fa-file "></i> Add Profile</a></li>
        </ul>
        ...
        <li class="nav-item"><a class="nav-link <?=$Settings;?>" href="?Mikbotam=Settings"><i class="fa fa-cog "></i> Settings</a></li>
          <li class="nav-item"><a class="nav-link <?=$SettingsVoc;?>" href="?Mikbotam=SettingsVoc"><i class="fa fa-file "></i> Settings Voucher</a></li>
          <li class="nav-item"><a class="nav-link " href="?Mikbotam=comingsoon"><i class="fa fa-file-text "></i> Text Settings</a></li>
        </ul>
        <a href="?Mikbotam=comingsoon" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <li class="nav-item"><a class="nav-link <?=$about;?>" href="?Mikbotam=about"><i class="fa fa-cog "></i> About</a></li>
          <li class="nav-item"><a class="nav-link " href="?Mikbotam=comingsoon"><i class="fa fa-file "></i> Change logs</a></li>
        </ul>
