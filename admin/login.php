...
<div class="login-wrapper  wd-xs-350 pd-20 bg-white" style="border-radius: 3px;border: 1px solid teal;">
        <div class="signin-logo">
            <center><img src="../img/progress.svg" alt="Italian logovail" class="img-fluid center" style="padding-bottom: 20px;width: 81%;padding-top: 0;">
          <h1><p class="mg-b-0" style="
    font-size: 48px;
    /* align-items: center; */
    letter-spacing: -1px;
"><img src="../img/logoM.svg" style="margin-top: -6px;width: 16%;">IKBOTAM</p></h1></center></div>
