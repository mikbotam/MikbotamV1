                ...
                <label class="custom-file">
                  ...
                  <span class="custom-file-control"></span>
                            ...
                            <div class="row row-xs mg-t-8">
                                <div class="col-sm-15 mg-l-auto">
                                    <div class="form-layout-footer">
                                        <button class="btn btn-success disable lh-0 tx-xthin mg-r-0 mg-t-8" onclick="makebroadcast();return false;"><i class="fa fa-paper-plane mg-r-2"></i> Send Photo</button>
